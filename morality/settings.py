"""
Django settings for morality project.
...
WSGI_APPLICATION = 'morality.wsgi.application'
...
DATABASES = {
   ...
   'default': {
            ...
            'NAME': 'morality',                      # Or path to database file if using sqlite3.
            # The following settings are not used with sqlite3:
            'USER': 'morality',
            'PASSWORD': 'morality123',
